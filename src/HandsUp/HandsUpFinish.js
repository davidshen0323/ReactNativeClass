...
export default class ExampleThree extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tableHead: ['學號', '姓名', '時間', '分數'],
      widthArr:[ 100, 80, 80, 60],
      tableData: [
        ['406401111', '沈大為', '11:01', '80'],
        ['406401202', '李佩倫', '11:02', '100'],
        ['406401599', '楊家誠', '11:03', '90'],
        ['406401616', '黃瀚頡', '11:03', '70'],
        ['406401628', '程榆晴', '11:05', '80'],
        ['406401111', '沈大為', '11:01', '80'],
        ['406401202', '李佩倫', '11:02', '100'],
        ['406401599', '楊家誠', '11:03', '90'],
        ['406401616', '黃瀚頡', '11:03', '70'],
              ...
              <Table borderStyle={{borderWidth: 1, borderColor: '#C1C0B9'}}>
                {
                  state.tableData.map((rowData, index) => (
                    <TableWrapper key={index} style={[styles.row, index%2 && {backgroundColor: '#ffffff'}]}>
                    {
